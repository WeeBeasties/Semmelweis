...
ggplot(plotData, aes(x=Year, y=Rate, colour=Hospital)) +
	scale_x_continuous(limits = c(1780, 1855), breaks = seq(1780, 1850, by = 10)) +
	...
	annotate("text", x = 1787, y = 17, label = "The Vienna hospital experienced an \n increase in mortality following the start \n of the Pathological Anatomy course", hjust = 0) +
	geom_vline(xintercept = 1847, linetype = "dotted") +
	annotate("text", x = 1825, y = 17, label = "Handwashing reduced \n rates to those of the \n Dublin hospital", hjust = 0) +
